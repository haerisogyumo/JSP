                ...
                <caption>사이트 이용정보 입력</caption>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button"><img src="/Farmstory1/user/img/chk_id.gif" alt=""></button>
                    ...
                    <tr>
                        ...
                        <td><p>공백없이 한글, 영문, 숫자만 입력가능</p><br/>
                            ...
                            <button type="button" id="btnNickCheck">
                                <img src="/Farmstory1/user/img/chk_id.gif" alt="중복확인">
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <img src="/Farmstory1/user/img/chk_post.gif" alt="우편번호 찾기">
                                </button>
                            </div>
                            <div>
