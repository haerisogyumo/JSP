...
<main id="user" class="register">
    <form action="/Farmstory2/user/register.do" mothod="post">
        <table border="1">
        ...
        <table border="1">
            ...
            <tr>
                <th>별명</th>
                <td>
                    <p class="nickInfo">공백없이 한글, 영문, 숫자 입력</p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" onclick="postcode()"><img src="/Farmstory2/img/chk_post.gif" alt="우편번호 찾기"/></button>
                    <input type="text" name="addr1" placeholder="기본주소 검색" id="addr1" readonly/>
