...
public enum ArticleService {
	...
	public int selectCountTotalForSearch(String search, String cate) {
		return dao.selectCountTotalBySearch(search, cate);
	}
	...
	public List<ArticleVO> selectArticleByKeyword(String cate , String search, int start) {
		return dao.selectArticlesByKeyword(cate ,search, start);
	}
